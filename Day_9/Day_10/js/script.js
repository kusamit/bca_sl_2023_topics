...
function randomval()
{
    // const rnd=document.getElementById("randomval")
    const generatedval=Math.random()
    document.getElementById("generatedDecimalValue").innerHTML="random value is"+generatedval
}